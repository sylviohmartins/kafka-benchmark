...
@EnableKafka
@Configuration
public class KafkaNormalConsumerConfig {
  ...
  @Bean
  public ConsumerFactory<String, BenchmarkMessage> normalConsumerFactory() {
    Map<String, Object> props = new HashMap<>();
    props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapServers);
    props.put(ConsumerConfig.GROUP_ID_CONFIG, "normal-consumer-group");
  ...
  @Bean
  public ConcurrentKafkaListenerContainerFactory<String, BenchmarkMessage> normalKafkaListenerContainerFactory() {
